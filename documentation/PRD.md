...
|---|---|
| Rendu | 100 % statique (SSG), export `docs/` en HTML complet servable sans serveur Node (voir §14.1), aucune dépendance JS pour le contenu |
...
| Sortie | **HTML/CSS/JS statiques purs** dans `docs/` | Servable par n'importe quel serveur de fichiers ou CDN, sans runtime Node en production — voir contrainte ci-dessous |
...
> dossier `docs/` de fichiers HTML/CSS/JS/assets purs, ouvrables et navigables **sans
...
```
/
├── documentation/        # PRD, stratégie SEO/GEO, user stories
├── README.md
├── src/
