...
export const laMaisonContent: Record<Locale, LaMaisonContent> = {
  fr: {
    ...
    pieces: [
      ...
      { slug: 'salle-a-manger', titre: 'La salle à manger', description: 'Grande table ronde, ouverte sur la cuisine — le cœur de la maison en open space.' },
      ...
      { slug: 'terrasse', titre: 'La terrasse', description: 'Table, banc et transats à l’ombre des arbres, donnant sur le jardin.' },
  ...
  en: {
    ...
    pieces: [
      ...
      { slug: 'salle-a-manger', titre: 'The dining room', description: 'A large round table, open onto the kitchen — the open-plan heart of the house.' },
      ...
      { slug: 'terrasse', titre: 'The terrace', description: 'Table, bench and loungers in the shade of the trees, looking onto the garden.' },
  ...
  de: {
    ...
    pieces: [
      ...
      { slug: 'salle-a-manger', titre: 'Das Esszimmer', description: 'Ein großer runder Tisch, offen zur Küche — das offene Herzstück des Hauses.' },
      ...
      { slug: 'terrasse', titre: 'Die Terrasse', description: 'Tisch, Bank und Liegestühle im Schatten der Bäume, mit Blick auf den Garten.' },
